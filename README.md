...
- Training new models for other languages of Africa or finetuning the published models. All the knowledge from training models is open source and will be shared freely to support you.  
